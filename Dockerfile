#Build a pseudo distributed and standalone Hadoop   version 2.8.5

FROM ubuntu:18.04

MAINTAINER Kennon <kennon.rodrigues@linkit.nl>
#LABEL version="hadoop_285_pseudo_distributed"
LABEL version="hadoop_285_standalone"
...
RUN useradd -rm hdfs
RUN cd ~/
RUN wget https://downloads.apache.org/hadoop/common/hadoop-2.8.5/hadoop-2.8.5.tar.gz ; tar -zxf hadoop-2.8.5.tar.gz -C /usr/local/ ; rm hadoop-2.8.5.tar.gz
